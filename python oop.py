# -*- coding: utf-8 -*-
"""
Created on Sun Nov 11 15:09:52 2018
...
m2=np.matrix('2 4;6 8')
am1=np.array(m1)
am2=np.array(m2)
arr1=np.array([1,2,3,4,5,6])
arr2=np.array([56,79,31,50,48,26])
np.cov(arr1,arr2)
np.corrcoef(arr1,arr2)


import pandas as pd
df1=pd.DataFrame(np.random.random(size=(5,1)),columns=['classA'])
df2=pd.DataFrame(np.random.random(size=(5,1)),columns=['classB'])
df1.join(df2)
...
import pandas as pd
df1 = pd.DataFrame(['K0', 'K1', 'K2', 'K3', 'K4', 'K5'], columns=['etf1'], index=['20', '21', '22', '23', '24', '25'])
df2 = pd.DataFrame(['K0', 'K1', 'K2'], columns=['etf2'], index=['20', '21', '22'])
